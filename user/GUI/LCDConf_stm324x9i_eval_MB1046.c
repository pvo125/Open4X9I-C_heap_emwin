...
#define LCD_LAYER1_FRAME_BUFFER  ((uint32_t)0xD017e800)
/**
* @}
*/ 
...
void LCD_X_Config(void) 
{
  uint32_t i;
	...
	HAL_LTDC_ProgramLineEvent(&hltdc, 0); //LCD_LL_Init ();
...
static void LCD_LL_LayerInit(uint32_t LayerIndex) 
{
  ...
  if (LayerIndex < GUI_NUM_LAYERS) 
  {
    ...
    layer_cfg.Alpha = 255;
    layer_cfg.Alpha0 = 0;
    layer_cfg.Backcolor.Blue = 100;
    layer_cfg.Backcolor.Green = 200;
    layer_cfg.Backcolor.Red = 50;
